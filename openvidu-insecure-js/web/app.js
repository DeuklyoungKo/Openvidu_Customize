...
function joinSession() {
	...
	session.on('signal:my-chat', (event) => {
		console.log("=========== signal:my-chat "); // Message
		console.log(event.data); // Message
		console.log(event.from); // Connection object of the sender
		console.log(event.from.data); // Connection object of the sender
		console.log(JSON.parse(event.from.data).clientData); // Message
		console.log(event.type); // The type of message ("my-chat")
		alert("[" + JSON.parse(event.from.data).clientData + "] " + event.data);
	});
...
function intervalFnc(){
	...
	if(intervalCount < 5){
		setCanvasSize()
		intervalCount++;
		timerId = setTimeout(intervalFnc, 500);
	}else{
...
function setCanvasSize(){
	...
	console.log($("#divC").css("width"));
	console.log($("#divC").css("height"));

	canvas.width = $("#divC").css("width").replace("px","");
	canvas.height = $("#divC").css("height").replace("px","");
	// canvas.width = $("#divC").css("width");
	// canvas.height = $("#divC").css("height");
}
...
// To send text mesages between users
